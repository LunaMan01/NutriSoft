...
<h3 class="mb-5">Nuevo tiempo de comida</h3>
	<div id="agregar" >
			...
			<div class="form-group">
							...
							<input type="text" name="Nombre_Tiempo" value="" pattern="[a-zA-Z]{1,15}" title="solo letras Mayusculas y Minusculas" class="form-control">
			</div>
			<div class="form-group">
							<label for="Hora_Tiempo">  Hora </label>
							<input type="text" name="Hora_Tiempo" value="" pattern="[0-9]{1,5}" title="numero en rango de 1-99999"class="form-control">
			</div>	
		...
		<?php
			...
			if (isset($_POST['Agregar'])) {
				...
				$sql="INSERT INTO tiempo_comida ( Nombre_Tiempo, Hora_Tiempo) VALUES ( '$Nombre_Tiempo','$Hora_Tiempo')";
